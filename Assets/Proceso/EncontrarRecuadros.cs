...
public class EncontrarRecuadros : MonoBehaviour
{
    ...
    public void ActualizarTexturaOrigen(Texture2D texturaInput)
    {
        //descarga
    ...
    public void AdaptThreshold(Mat mat, Mat matout=null){
        Cv2.AdaptiveThreshold(mat, matout==null?mat:matout, valorNuevoDeUmbral, tipoAdaptativo, tipoUmbral, TamBloqueAdaptativo, constanteAdaptativo);
    }
